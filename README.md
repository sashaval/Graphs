...
For example, node (26.5)Tumors, mentions meningioma, which is a tumor originating in the meninges. This note contains an Obsidian backlink to the node (3.7)Meninges, creating an egde between them.
...
Seemless integration of the nodes on the graph render allows the user to recognize how chapters connect at a glance.
